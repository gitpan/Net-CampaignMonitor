# This Makefile is for the Net::CampaignMonitor extension to perl.
#
...
MAKE = make
FULLEXT = Net/CampaignMonitor
BASEEXT = CampaignMonitor
PARENT_NAME = Net
DLBASE = $(BASEEXT)
VERSION_FROM = lib/Net/CampaignMonitor.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Net/CampaignMonitor.pm
...
TO_INST_PM = example.pl \
	lib/Net/CampaignMonitor.pm \
	package.pl

PM_TO_BLIB = package.pl \
	$(INST_LIB)/Net/package.pl \
	lib/Net/CampaignMonitor.pm \
	blib/lib/Net/CampaignMonitor.pm \
	example.pl \
	$(INST_LIB)/Net/example.pl
...
DISTVNAME = Net-CampaignMonitor-v2.1.1
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Net/CampaignMonitor.pm $(INST_MAN3DIR)/Net::CampaignMonitor.$(MAN3EXT) 
...
ppd :
	$(NOECHO) $(ECHO) '<SOFTPKG NAME="$(DISTNAME)" VERSION="v2.1.1">' > $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  package.pl $(INST_LIB)/Net/package.pl \
	  lib/Net/CampaignMonitor.pm blib/lib/Net/CampaignMonitor.pm \
	  example.pl $(INST_LIB)/Net/example.pl 
